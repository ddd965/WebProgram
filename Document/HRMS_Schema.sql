...
/* --- 3.1 部门（先插入顶级节点，ParentId=NULL；再逐层插入子部门） --- */
SET IDENTITY_INSERT dbo.Department ON;
INSERT INTO dbo.Department(DeptId,DeptName,ParentId,Descn) VALUES
 (1,N'总公司',   NULL, N'公司最高层级')
,(2,N'技术部',    1,   N'研发、测试、运维')
,(3,N'人事部',    1,   N'人力资源与行政管理')
,(4,N'财务部',    1,   N'会计、出纳、税务')
,(5,N'市场部',    1,   N'销售、品牌、客户关系')
,(6,N'研发组',    2,   N'软件开发')
,(7,N'运维组',    2,   N'基础设施与运维')
,(8,N'招聘组',    3,   N'人才引进')
,(9,N'薪酬组',    3,   N'薪酬福利与员工关系');
