...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ValidationSummary runat="server" ID="vs" CssClass="alert alert-danger" HeaderText="请完善以下必填项："
        ValidationGroup="EditGrp" ShowMessageBox="false" ShowSummary="true" />
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmpNo" ValidationGroup="EditGrp"
                            CssClass="text-danger" ErrorMessage="工号必填" Display="Dynamic" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmpName" ValidationGroup="EditGrp"
                            CssClass="text-danger" ErrorMessage="姓名必填" Display="Dynamic" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="txtIdCard"
                            CssClass="text-danger" Display="Dynamic" ValidationGroup="EditGrp"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtHireDate" ValidationGroup="EditGrp"
                            CssClass="text-danger" ErrorMessage="入职日期必填" Display="Dynamic" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPhone" ValidationGroup="EditGrp"
                            CssClass="text-danger" ErrorMessage="电话必填" Display="Dynamic" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmail" ValidationGroup="EditGrp"
                            CssClass="text-danger" ErrorMessage="邮箱必填" Display="Dynamic" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-9">
                        <asp:Button runat="server" ID="btnSave" Text="保存" OnClick="btnSave_Click" ValidationGroup="EditGrp"
